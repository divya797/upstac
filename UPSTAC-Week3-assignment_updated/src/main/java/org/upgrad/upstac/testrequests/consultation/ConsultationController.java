...
public class ConsultationController {
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        log.info(testResult.toString());	
        	 User loggedInUser = userLoggedInService.getLoggedInUser();// getting currently logged in doctor
             TestRequest result = testRequestUpdateService.updateConsultation(id,testResult,loggedInUser);// updating the given consultation details for given test request(by id) for the given doctor
             return result;
